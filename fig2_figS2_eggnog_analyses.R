...
packages <- c("stringr", "reshape2","digest", "ggplot2", 'scales', "spaa", "xlsx", "viridis", "DESeq2", "Rmisc",
...
#selection of groups 
groups_selected=c("Carbohydrate transport and metabolism","Defense mechanisms",
...
groups_1_levels=c("cazys","fermentation","carbon_fixation", "TCA cycle","respiration (aerobic)","respiration (anaerobic)","Stress response",
                  "Defense", "Competition","DNA, translation regulation", "protein modification and turnover respiration (aerobic)")

groups_2_levels=c("cazys","fermentation","Photosynthesis","calvin cycle (aerobic)","Arnon-Buchanan cycle (anaerobic)","methanogenesis",
...
eggnog_md_sel_sum2=eggnog_md_sel_sum2[order(factor(eggnog_md_sel_sum2$groups_1, levels = groups_1_levels),
...
################### DIVERSITY AND ABUNDANCE, fig S2 #########################
