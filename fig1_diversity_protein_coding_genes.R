...
gh <- posthocTGH(richness_total2$richness_total, richness_total2$variable,
  method = c("games-howell"),
  conf.level = 0.95, digits = 2, p.adjust = "none",
  formatPvalue = TRUE
) # Games-Howell test that is a recommended post hoc test after welch
...
gh <- posthocTGH(shannon$value, shannon$variable,
  method = c("games-howell"),
  conf.level = 0.95, digits = 2, p.adjust = "none",
  formatPvalue = TRUE
) # Games-Howell test that is a recommended post hoc test after welch
